...
- [ ] T010 [P] [US1] Create table-driven unit tests for Syslog parsing (PRI, Header, CEF message) in tests/unit/test_parser.py
- [ ] T011 [US1] Create integration test for TCP ingestion of RFC 3164 Syslog logs in tests/integration/test_server.py

### Implementation for User Story 1
- [ ] T012 [P] [US1] Implement Syslog PRI extraction and facility/severity resolver in src/parser.py
- [ ] T013 [P] [US1] Implement CEF Extension message scanner/parser in src/parser.py
- [ ] T014 [US1] Map parsed Syslog/CEF fields to NormalizedLog models in src/parser.py
- [ ] T015 [US1] Integrate Syslog parser into the TCP reader stream processing coroutine in src/server.py
- [ ] T016 [US1] Add console output writer or basic file sink in src/server.py
...
- [ ] T017 [P] [US2] Create unit tests for format detection (Syslog vs JSON) and nested Windows JSON extraction paths in tests/unit/test_parser.py
- [ ] T018 [US2] Create integration test for TCP ingestion of NDJSON logs in tests/integration/test_server.py

### Implementation for User Story 2
- [ ] T019 [US2] Implement first-character inspection format detector in src/parser.py
- [ ] T020 [P] [US2] Implement nested field path extraction for Windows Event Logs in src/parser.py
- [ ] T021 [US2] Map extracted Windows JSON fields to NormalizedLog attributes in src/parser.py
- [ ] T022 [US2] Integrate JSON parser routing in the TCP reader stream handler in src/server.py
...
- [ ] T023 [P] [US3] Create unit tests for parser exception handling and fallback mapping in tests/unit/test_parser.py
- [ ] T024 [US3] Create integration test sending invalid lines to server and checking error logs in tests/integration/test_server.py

### Implementation for User Story 3
- [ ] T025 [US3] Implement line-oriented try-except blocks to catch parser errors in src/server.py
- [ ] T026 [US3] Add dead-letter routing to log malformed events without interrupting the stream in src/server.py
...
- Unit tests and parser logic (e.g. T012, T013) can be developed in parallel.
